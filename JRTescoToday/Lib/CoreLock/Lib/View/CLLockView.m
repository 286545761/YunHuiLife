...
-(void)layoutSubviews{
    ...
    [super layoutSubviews];
     CGFloat topViewHeight3 = iPhone4||iPhone5||iPhone6 ?  32:45;
    CGFloat itemViewWH = (self.frame.size.width - 4 * marginValue) /4.0f;
    ...
    [self.subviews enumerateObjectsUsingBlock:^(UIView *subview, NSUInteger idx, BOOL *stop) {
        ...
        if (iPhone5) {
            CGRect frame = CGRectMake(x+28, y, itemViewWH, itemViewWH);
            subview.tag = idx;
      ...
      {
           CGRect frame = CGRectMake(x+topViewHeight3, y, itemViewWH, itemViewWH);
          subview.tag = idx;
