...
@interface JREditProductViewController ()<JRProductTagView,JRProductCategoryViewDelegate,JREditCategoryViewControllerDelegate>
...
@implementation JREditProductViewController
...
- (void)giveModel:(JREditProductModel *)editingModel {
    ...
    _categoryView.categoryLabel.text = editingModel.categoryName;
    _categoryView.selectCategoryID = editingModel.goodsCategoryId;
...
- (void)clickSave:(UIButton *)sender {
    ...
    [JRBusinessCenterCore uploadEdit_ProductWithAccess_tokenToken:token productID:self.productID name:title mainImage:image descp:description goodsPrice:presentPrice originalPrice:originalPrice goodsCategoryId:categoryID type:@"0" labels:tagArr Successed:^(NSDictionary *data) {
...
- (void)clickRelease:(UIButton *)sender {
    ...
    //
    NSString *token = [FNUserDefaults objectForKey:@"usersid"];
    [JRBusinessCenterCore uploadEdit_ProductWithAccess_tokenToken:token productID:self.productID name:title mainImage:image descp:description goodsPrice:presentPrice originalPrice:originalPrice goodsCategoryId:categoryID type:@"1" labels:tagArr Successed:^(NSDictionary *data) {
