...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *finish = [[UIBarButtonItem alloc] initWithTitle:@"完成" style:UIBarButtonItemStylePlain target:self action:@selector(finishSelecting)];
     finish.tintColor=[UIColor  blackColor];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell.selectedButton == nil) {//防止多次创建
        ...
        [selectButton setImage:[UIImage imageNamed:@"组-40"] forState:UIControlStateNormal];
        [selectButton setImage:[UIImage imageNamed:@"06shouye"] forState:UIControlStateSelected];
