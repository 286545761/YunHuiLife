...
/*! alterview添加添加点击事件 默认：1*/
typedef NS_ENUM(NSInteger, DSAlertTapStyle) {
    /*! 四周可以点击 */
    DSAlertTapStyleALlSides = 1,
    /*! 全屏点击 */
    DSAlertTapStyleALLScreen = 2,
...
/*! 背景点击范围枚举 默认：1 */
@property (nonatomic, assign) DSAlertTapStyle blurTapStyle;
